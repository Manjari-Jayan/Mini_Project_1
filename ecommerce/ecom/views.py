...
#---------AFTER ENTERING CREDENTIALS CHECKUNG WHETHER USERNAME AND PASSWORD IS OF ADMIN OR CUSTOMER
...
def remove_from_cart_view(request,pk):
    #for counter in cart showing an error even after removing it checkkkkkkkkkkkkkkkkkkk
    if 'product_ids' in request.COOKIES:
        product_ids = request.COOKIES['product_ids']
        counter=product_ids.split('|')
        product_count_in_cart=len(set(counter))
